...
export const cvData: CVEntry[] = [
  {
    ...
    period: "",
    details: [
      "Results-oriented software engineering leader with 4+ years of experience leading, managing, and mentoring high-performing engineering teams in fast-paced, high-growth environments, including the largest ed-tech company in Southeast Asia. Proven track record of delivering impactful projects, such as leading a core banking migration that resulted in a 95% reduction in operational costs. Passionate about technical excellence, team development, and product innovation. I enjoy seeing my teams grow, deliver value, and stay technically competent. While I appreciate functional programming, I believe paradigms and languages are tools for achieving goals.",
      "Beyond technical skills, I'm a polyglot with more than three languages and experience living overseas. I contribute to the community through my website and YouTube channel, AyoKoding. I'm seeking to leverage my expertise in software engineering to contribute to building innovative and scalable solutions.",
    ],
    links: {
